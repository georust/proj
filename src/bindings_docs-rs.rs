...
fn bindgen_test_layout_PROJ_UNIT_INFO() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PROJ_UNIT_INFO>())).auth_name as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PROJ_UNIT_INFO>())).code as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(PROJ_UNIT_INFO),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PROJ_UNIT_INFO>())).name as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(PROJ_UNIT_INFO),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PROJ_UNIT_INFO>())).category as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(PROJ_UNIT_INFO),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PROJ_UNIT_INFO>())).conv_factor as *const _ as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(PROJ_UNIT_INFO),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PROJ_UNIT_INFO>())).proj_short_name as *const _ as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(PROJ_UNIT_INFO),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PROJ_UNIT_INFO>())).deprecated as *const _ as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(PROJ_UNIT_INFO),
