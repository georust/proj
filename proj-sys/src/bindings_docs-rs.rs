...
pub const PROJ_VERSION_MAJOR: u32 = 8;
...
fn bindgen_test_layout_PROJ_CRS_INFO() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PROJ_CRS_INFO>())).celestial_body_name as *const _ as usize
        },
        88usize,
        concat!(
            "Offset of field: ",
...
fn bindgen_test_layout_PROJ_CRS_LIST_PARAMETERS() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PROJ_CRS_LIST_PARAMETERS>())).celestial_body_name as *const _
                as usize
        },
        64usize,
        concat!(
...
fn bindgen_test_layout_PROJ_CELESTIAL_BODY_INFO() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PROJ_CELESTIAL_BODY_INFO>())).auth_name as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PROJ_CELESTIAL_BODY_INFO>())).name as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(PROJ_CELESTIAL_BODY_INFO),
